 ...
 * Due Date: 6/12/2019
 * This class tests add and remove methods of an AVL tree.
 The AVLFrame class builds the user interface and
 supports user interaction.
 */

public class DD_AVLTreeDemo extends JFrame implements ActionListener
{
    // AVL Tree and a Displayable wrapper.
    private DD_AVLTree avlTree = new DD_AVLTree();
    private DD_DisplayableBtree
            displayAvlTree = new DD_DisplayableBtree(avlTree);
